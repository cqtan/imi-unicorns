...
ap.add_argument("-t","--dataset_train",type=str, required=True,help="(required) the train data directory")
ap.add_argument("-v","--dataset_val",type=str, required=True,help="(required) the validation data directory")
